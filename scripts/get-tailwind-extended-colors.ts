...
import {createNewAutoGeneratedImportFile} from "./create-tailwind-import-functions";
...
let folder = await arg(
    {
        name: "Which tailwind project?",
        shortcuts: [
            {
                ...
                onPress: async (input, { focused }) => {
                    setChoices(await createNewAutoGeneratedImportFile())
                },
            },
        ],
    }, await getTailwindProjects());
